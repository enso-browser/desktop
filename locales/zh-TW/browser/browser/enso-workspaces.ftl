...
enso-panel-ui-workspaces-text = 工作區
...
enso-workspaces-panel-unload = 
    .label = 卸載工作區
enso-workspaces-how-to-reorder-title = 如何排序工作區
enso-workspaces-how-to-reorder-desc = 拖曳側邊欄底部工作區圖示以重新排序
...
enso-panel-ui-gradient-generator-algo-floating = 
    .label = 懸浮
enso-panel-ui-gradient-click-to-add = 點擊新增顏色
...
enso-workspaces-panel-context-reorder = 
    .label = 排序工作區
enso-workspace-creation-profile = 設定檔
    .tooltiptext = 設定檔用於隔離不同工作區的 Cookie 和網站資料。
enso-workspace-creation-header = 建立工作區
enso-workspace-creation-label = 工作區用於組織您的分頁與工作階段。
enso-workspaces-delete-workspace-title = 刪除工作區？
enso-workspaces-delete-workspace-body = 您確定要刪除 { $name } 嗎？此操作無法復原。
# Note that the html tag MUST not be changed or removed, as it is used to better
# display the shortcut in the toast notification.
enso-workspaces-close-all-unpinned-tabs-toast = 分頁已關閉！使用 <span>{ $shortcut }</span> 來回復此動作。
