...
export default [
  ...
  "gEnsoCompactModeManager",

  "gEnsoWindowSync",

  "gEnsoUIManager",
  "gEnsoVerticalTabsManager",
  "gEnsoStartup",
  "gEnsoMenubar",

  "gEnsoWorkspaces",
  "gEnsoKeyboardShortcutsManager",
  "EnsoWorkspacesEngine",
  "EnsoWorkspaceBookmarksStorage",

  "ENSO_KEYSET_ID",

  "gEnsoPinnedTabManager",

  "gEnsoEmojiPicker",
  "gEnsoSessionStore",
  "gEnsoFolders",
  "gEnsoMediaController",
  "gEnsoGlanceManager",
