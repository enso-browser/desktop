...
add_task(async function test_Split_View_Empty() {
  await BrowserTestUtils.withNewTab("https://example.com", async function () {
    ...
    ok(!gEnsoWorkspaces._emptyTab.splitView, "The empty tab should not be in split view");
    ok(!gEnsoWorkspaces._emptyTab.group, "The empty tab should not be in a group");
    ...
    Assert.equal(
      gBrowser.tabpanels.querySelectorAll('[enso-split="true"]').length,
      2,
