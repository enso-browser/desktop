...
add_task(async function test_Empty_Tab_Transparent() {
  ...
  ok(emptyTab.hasAttribute("enso-empty-tab"), "Empty tab should have the enso-empty-tab attribute");
  ok(
...
add_task(async function test_Empty_Tab_Always_First() {
  ok(gBrowser.tabs[0].hasAttribute("enso-empty-tab"), "First tab should be the empty tab");
