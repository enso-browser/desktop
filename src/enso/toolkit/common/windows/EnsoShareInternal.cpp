...
auto nsZenNativeShareInternal::ShowNativeDialog(
  ...
  (void)WindowsUIUtils::Share(enso::NS_ConvertUTF8toUTF16_MaybeVoid(aTitle),
                              enso::NS_ConvertUTF8toUTF16_MaybeVoid(aText),
                              enso::NS_ConvertUTF8toUTF16_MaybeVoid(urlString));
  return NS_OK;
}
