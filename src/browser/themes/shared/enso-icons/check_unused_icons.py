...
#       python3 src/browser/themes/shared/enso-icons/check_unused_icons.py
...
def main(args):
  parser = argparse.ArgumentParser(description='Check for unused enso icons.')
  parser.add_argument('--remove', action='store_true', help='Remove unused icons')
  parsed_args = parser.parse_args(args)

  icon_dir = 'src/browser/themes/shared/enso-icons/lin'
  ...
  if parsed_args.remove:
    ...
    os.chdir('src/browser/themes/shared/enso-icons')
